...
CREATE INDEX IF NOT EXISTS payments_date_method_posted_idx
...
CREATE INDEX IF NOT EXISTS assessments_sy_outstanding_idx
...
CREATE INDEX IF NOT EXISTS discount_requests_pending_created_idx
...
ON grade_sheets (status, submitted_at)
...
CREATE INDEX IF NOT EXISTS doc_requests_student_history_idx
...
CREATE INDEX IF NOT EXISTS booklets_active_usage_idx
...
CREATE INDEX IF NOT EXISTS ecr_pending_created_idx
...
CREATE INDEX IF NOT EXISTS clearances_student_pending_idx
