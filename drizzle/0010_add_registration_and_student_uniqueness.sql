...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS "registrations_student_sy_active_uidx"
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS "students_name_dob_active_uidx"
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "students_name_dob_lookup_idx"
  ON "students" (LOWER("first_name"), LOWER("last_name"), "date_of_birth")
