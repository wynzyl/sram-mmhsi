...
function studentsListHref(opts: { q?: string; schoolYearId?: string; page?: number }) {
  ...
  const s = p.toString();
  return s ? `/staff/students?${s}` : "/staff/students";
}
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        ...
        {canCreate && (
          <Link href="/staff/register" className="btn-primary" id="register-student-btn">
            + Register Student
          </Link>
        )}
      </div>
      ...
      <StudentsTable rows={tableRows} emptyMessage={emptyMessage} studentBasePath="/staff/students" />
