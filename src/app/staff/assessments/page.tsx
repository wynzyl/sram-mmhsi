...
export default async function StaffAssessmentsListPage({ searchParams }: PageProps) {
    ...
    <div className="page-container max-w-7xl">
      ...
      {tab === "pending" ? (
        <PendingAssessmentsQueue
          rows={pendingData}
          canCreate={canCreate}
          assessmentsBasePath={BASE}
        />
      ) : (
        <AssessmentsTable assessments={tableData} assessmentsBasePath={BASE} />
      )}
    </div>
  );
}
