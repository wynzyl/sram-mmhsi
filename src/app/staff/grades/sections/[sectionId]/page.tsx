...
export default async function AdviserGradeEntryPage({
  ...
  // Fetch grading system type first (needed for all sections)
      ...
      <div className="space-y-6">
        ...
        {shsStudents.length === 0 ? (
          ...
          <div className="p-12 text-center bg-card rounded-xl border border-border shadow-sm">
            ...
            <h3 className="mt-2 text-sm font-medium text-foreground">
              No subject offerings configured
            </h3>
            <p className="mt-1 text-sm text-muted-foreground">
              No subject offerings are configured for this section. Please generate
              subject offerings from the section management page.
            </p>
          </div>
