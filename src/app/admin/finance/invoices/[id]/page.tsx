    ...
    return (
      <div className="page-container">
        ...
        <div className="content-card">
          ...
          <Link href="/admin/finance/invoices" className="btn-secondary" style={{ marginTop: "1rem", display: "inline-block" }}>
            Back to Invoices
          </Link>
        </div>
      </div>
    ...
    <div className="page-container">
      <div className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          <Link href="/admin/finance/invoices" className="btn-secondary">
            Back to List
          </Link>
          ...
          <div className="detail-item">
            ...
            <span className="detail-value">
              {invoice.assessmentId ? (
                <Link href={`/admin/assessments/${invoice.assessmentId}`} className="table-action-link">
                  View Assessment
                </Link>
              ) : (
                "None"
