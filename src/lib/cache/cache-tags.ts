 ...
 *                   -> src/features/academics/curriculums/curriculums.queries.ts (getCurriculumById)
 ...
 * - CURRICULUM_ADOPTIONS -> src/features/academics/curriculums/curriculums.queries.ts (getAdoptionMatrix, listCurriculums, getCurriculumById)
