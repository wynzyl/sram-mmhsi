...
interface AccountsReceivableReportActionsProps {
  schoolYearId?: string;
}

export function AccountsReceivableReportActions({
  schoolYearId,
}: AccountsReceivableReportActionsProps) {
  const download = (format: "pdf" | "xlsx") => {
    ...
    a.href = `/staff/reports/accounts-receivable/export?${params.toString()}`;
