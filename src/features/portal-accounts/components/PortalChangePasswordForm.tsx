...
export function PortalChangePasswordForm() {
  ...
  const [state, action, pending] = useActionState<ChangePortalPasswordFormState, FormData>(
  ...
  return (
    <form className="flex flex-col gap-[1.125rem]" action={action} noValidate>
      ...
      <div className="flex flex-col gap-[0.4375rem]">
        ...
        <p className="text-xs text-[#5b524a] dark:text-[#b8aea4] m-0 leading-snug mb-1">
          Your date of birth in YYYYMMDD format (e.g., 20100315)
        </p>
