...
/**
 * Get grade sheets that have been published (ready to lock).
 */
export async function getPublishedSheets(
  schoolYearId: string
): Promise<GradeSheetView[]> {
  const whereClause = and(
    eq(gradeSheets.schoolYearId, schoolYearId),
...
/**
 * Get grade sheets that have been locked.
 */
export async function getLockedSheets(
  schoolYearId: string
): Promise<GradeSheetView[]> {
  const whereClause = and(
    eq(gradeSheets.schoolYearId, schoolYearId),
